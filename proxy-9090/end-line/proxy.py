"""
END LINE RFID Proxy Server (Port 9090)
Receives RFID scans from hardware and forwards to end-line backend
...
if __name__ == '__main__':
    ...
    logger.info("="*60)
    logger.info("END LINE RFID PROXY SERVER")
    logger.info("="*60)
